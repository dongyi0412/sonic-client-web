...
<template>
    <el-card>
        ...
        统计类型:
        <el-select v-model="countType" placeholder="选择统计类型" size="small" @change="getData" style="width: 120px">
            <el-option
    ...
    <el-row :gutter="20" style="margin-top: 20px">
        <el-col :span="8">
            <el-table :data="result['case']" style="width: 100%" border v-loading="loading">
                <el-table-column
                        header-align="center"
